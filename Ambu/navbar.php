...
<div class="btn-group">
  ...
  <ul class="dropdown-menu dropdown-menu-end">
    ...
    <li><a class="dropdown-item" href="ambulance.php">Ambulances</a></li>
    <li style="padding-left: 1vw;"><button class="dropdown-item" ><?php if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == false){ ?>
        <div id="cot" class="container" style="background-color: #DBF9FC;width:50%">
            ...
            <a href="ambulogin.php" class="btn btn-success">Go Back</a>
        </div>
    <?php }
    else { ?>
    ...
    <div>
    <a href="ambulogout.php"><button class="btn btn-success">Log Out</button></a>
