...
if ($num == 1){
    ...
    echo" Password or  Customer_ID is wrong";
}
...
<div class="ui menu" style="padding-top:5%;">
  ...
  <div id="cot" class="container " style="background-color: #DBF9FC;width:40%"><h1>User</h1>
    <div class="dropdown">
...
<form action="" method="POST" class="form" style="margin-left: 9vw">
            ...
            <input style="width: 70%" type="number" name="Customer_ID"></input><br>
            <label for="password">Password: </label><br>
            <input style="width: 70%" type="password" name="password"></input><br><br>
            <input class="btn btn-success"type = "submit" value = "Log In"></input><br>
            <label> </label>
        </form>
    </div>
</div>
