...
$sql = "Select * from fire_station where FS_ID='$FS_ID' AND Password='$password'";
...
if ($num == 1){
    ...
    header("location:Fire/firehome.php");

}
else{
    echo" Password or  FS_ID is wrong";
}
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    ...
    <li><a class="dropdown-item" href="ambulogin.php">Ambulance</a></li>
        ...
        <form action="" method="POST" class="form" style="margin-left: 9vw">
            <label for="FS_ID">Fire Station ID: </label><br>
            <input style="width: 70%"type="number" name="FS_ID"></input><br>
