...
$sql = "Select * from police_station where PS_ID='$PS_ID' AND Password='$password'";
...
if ($num == 1){
    ...
    echo" Password or  PS_ID is wrong";
}
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    ...
    <li><a class="dropdown-item" href="ambulogin.php">Ambulance</a></li>
        ...
        <form action="" method="POST" class="form" style="margin-left: 9vw">
            <label for="PS_ID">Police ID: </label><br>
            <input style="width: 70%" type="number" name="PS_ID"></input><br>
