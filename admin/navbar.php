...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="adminhomepage.php">Smart Emergency Services </a>
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu dropdown-menu-end">
    ...
    <li><a class="dropdown-item" href="admin_createacc.php">Admin Account Create</a></li>
    ...
    <div>
    <a href="adminlogout.php"><button class="btn btn-success">Log Out</button></a>
