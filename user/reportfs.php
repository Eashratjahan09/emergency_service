...
<div id="cot" class="container" style="background-color: #DBF9FC;width:40%; padding-left: 13vw;">
        <h1>Report</h1>
<form class="ui form" method=get action=reportfs_inserter.php>
...
<br> <input readonly type=number value="<?php echo $aid?>"name=aid hidden> <br>
      ...
      <p>
        Service ID:<br> <input style="width: 70%"readonly type=number value="<?php echo $fsid?>"name=fsid > <br>
      ...
      <p>
       Report content:<br> <textarea  name=content style="height: 200px;text-align: top; width: 70%;"></textarea>  <br>
